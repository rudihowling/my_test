This script is designed to generate a local roster of active users from the Google Admin Console by removing unqualified users (non-users). It outputs a clean list of only active, valid users.
